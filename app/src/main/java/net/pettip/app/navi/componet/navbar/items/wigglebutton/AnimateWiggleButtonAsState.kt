...
data class WiggleButtonParams(
    @FloatRange(from = 0.0, to = 1.0) val scaleX: Float = 1.0f,
    @FloatRange(from = 0.0, to = 1.0) val scaleY: Float = 1.0f,
...
fun animateWiggleButtonAsState(
    ...
    return produceState(
        ...
        this.value = this.value.copy(
            scaleX = scaleInterpolator(enterExitFraction.value),
            scaleY = scaleInterpolator(enterExitFraction.value),
